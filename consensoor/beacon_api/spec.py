...
def build_spec_response() -> dict:
    ...
    spec = {
        ...
        "CHURN_LIMIT_QUOTIENT_GLOAS": str(constants.CHURN_LIMIT_QUOTIENT_GLOAS()),
        "CONSOLIDATION_CHURN_LIMIT_QUOTIENT": str(constants.CONSOLIDATION_CHURN_LIMIT_QUOTIENT()),
        "MAX_PER_EPOCH_ACTIVATION_CHURN_LIMIT_GLOAS": str(constants.MAX_PER_EPOCH_ACTIVATION_CHURN_LIMIT_GLOAS()),
