...
def build_spec_response() -> dict:
    ...
    spec = {
        ...
        "ATTESTATION_DUE_BPS": str(net_config.attestation_due_bps),
        "AGGREGATE_DUE_BPS": str(net_config.aggregate_due_bps),
        "SYNC_MESSAGE_DUE_BPS": str(net_config.sync_message_due_bps),
        "CONTRIBUTION_DUE_BPS": str(net_config.contribution_due_bps),
        "ATTESTATION_DUE_BPS_GLOAS": str(net_config.attestation_due_bps_gloas),
        "AGGREGATE_DUE_BPS_GLOAS": str(net_config.aggregate_due_bps_gloas),
        "SYNC_MESSAGE_DUE_BPS_GLOAS": str(net_config.sync_message_due_bps_gloas),
        ...
        "CONFIRMATION_BYZANTINE_THRESHOLD": str(net_config.confirmation_byzantine_threshold),
