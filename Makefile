...
.PHONY: all clean help docker fetch-tests \
...
help:
	...
	@echo ""
	@echo "Usage:"
	@echo "  make test <fork> [preset]      - Run reference tests (default: mainnet)"
	@echo "  make test all [preset]         - Run all reference tests"
	@echo ""
	@echo "Examples:"
...
_run-test: clean-cache fetch-tests
	@if [ "$(FORK)" = "all" ]; then \
...
test-phase0-minimal: fetch-tests
...
test-phase0-mainnet: fetch-tests
...
test-bellatrix-mainnet: fetch-tests
...
test-gloas-mainnet: fetch-tests
